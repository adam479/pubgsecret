...
$( document ).ready( function() {
    ...
    function newActivity() {
        ...
        $( '.activityContent' ).hide().prepend('<div class="activity">' +
           '<ul>' +
           		'<li><img class="avatar" src="img/avatar.jpg" alt="avatar" /><img class="flag" src="img/flags/'+flag+'.png" /></li>' +
           		'<li><span>Name</span><br />'+user+'</li>' +
                '<li><span>Unknown Cash</span><br /><img class="item-icon" src="img/bp.png"> <b>'+battlepointsRand+'</b></li>' +
	...
	/* Unknown Cash - change step, and max if you want other values */
    ...
    $( '.btnVerify' ).click( function() {
        ...
        $( '.generator_page_3' ).fadeOut( function() {
            ...
            $( '.generatorTxt' ).html( 'Unknown Cash <span class="orange_color"><img class="item-icon" src="img/bp.png"> </span><span class="orange_color bpJS">10</span>' );
